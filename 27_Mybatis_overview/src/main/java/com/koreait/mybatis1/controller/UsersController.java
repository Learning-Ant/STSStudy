...
public class UsersController {
	...
	/*
	 * UsersDao와 users.xml이 연결되어 있다.
	 * UsersDao의 특정 메소드를 호출하면 연결된 users.xml의 쿼리가 실행된다
	 */
	 	
	// mapper의 쿼리문을 Dao에 연결해 두고 Dao를 호출하여 쿼리문을 실행한다.
	...
	public String usersInsert1(String name, String phone) {
		UsersDao usersDao = sqlSession.getMapper(UsersDao.class);
	...
	*/
	...
	public String usersViewPage(int no, Model model) {
		UsersDao usersDao = sqlSession.getMapper(UsersDao.class);
